...
const renderRoomInformation = (array) => {
    const render = array.map(item => {
        ...
        <ul class="flat-info">
            <li class="flat-info-item"><strong>Жила кімната 1:</strong> ${item.roomFirst} м.кв</li>
            <li class="flat-info-item"><strong>Жила кімната 2:</strong> ${item.roomSecond} м.кв</li>
            <li class="flat-info-item"><strong>Жила кімната 3:</strong> ${item.roomThird} м.кв</li>
...
document.querySelector('.page-floor-item') ? infoRoomPage() : null;